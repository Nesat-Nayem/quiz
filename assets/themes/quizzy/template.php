...
<!-- <div id="dl-menu" style="margin-top: 20px !important;" class="dl-menuwrapper mt-2">
  <a href="https://dpam.nesatnayem.xyz/" class="dl-triggern web-home-link" style="text-decoration: none;">
    <?php echo lang('Web Home'); ?>
  </a>
</div> -->

<div id="dl-menu" style="margin-top: 20px !important;" class="dl-menuwrapper mt-2">
  <a href="https://dpam.nesatnayem.xyz/" class="web-home-link" style="text-decoration: none;">
    <?php echo lang('Web Home'); ?>
  </a>
</div>
                  ...
                  <div class="row">
                    <div class="col-3 pr-0">
                      <select name="header_search_type" class="serch_selection">
                        <option <?php echo ($this->uri->segment(1) == 'search' && $this->uri->segment(2) == 'quiz') ? 'selected' : ''; ?> value="quiz"><?php echo lang('I Am Winner'); ?></option>
                        <option <?php echo ($this->uri->segment(1) == 'search' && $this->uri->segment(2) == 'study') ? 'selected' : ''; ?> value="study"><?php echo lang('scholarship'); ?></option>
                        <option <?php echo ($this->uri->segment(1) == 'search' && $this->uri->segment(2) == 'category') ? 'selected' : ''; ?> value="category"><?php echo lang('navodaya'); ?></option>
                        <option <?php echo ($this->uri->segment(1) == 'search' && $this->uri->segment(2) == 'tutor') ? 'selected' : ''; ?> value="tutor"><?php echo lang('Grammar & Other'); ?></option>
                      </select>                
                    </div>
