...
<div class="container">
  ...
  <div class="row">
    <div class="col-12 text-center">
      <h2 class="heading"><?php echo ucwords($category_data->category_title); ?></h2>
      <hr>
    </div>
    <?php
          ...
          <div class="grid">
            ...
            <figure class="effect-ming">
              ...
              <figcaption>
                ...
                <a href="<?php echo $category_url; ?>" class="<?php echo $category_class; ?>"
                  data-category_slug='<?php echo $category_array->category_slug; ?>'>&nbsp;</a>
                <div class="row">
                ...
                <div class="card-body py-2 px-1">
                  ...
                  if ($sub_category_data) {
                    ...
                    foreach ($sub_category_data as $category_array) {
                      ...
                      ?>
                      <input type="checkbox" <?php echo $checked; ?> class="float-left filter-click"
                        data-field_slug="sub-category" name="subcategory"
                        value="<?php echo $category_array->category_title; ?>">
                      <div class="sub-category"><?php echo $category_array->category_title; ?></div>
              ...
              <div id="collapseThree3" class="collapse show" role="tabpanel">
                <div class="card-body p-1 ">
                  <div class="rating-star-main">
                    ...
                    <input type="radio" <?php echo $rating_checked; ?> name="rattings" value="4.5"
                      class="float-left filter-click" data-field_slug="rating">
                  ...
                  <div class="rating-star-main">
                    ...
                    <input type="radio" <?php echo $rating_checked; ?> name="rattings" value="4.0"
                      class="float-left filter-click" data-field_slug="rating">
                    <div class="average-star rating-star">
                      <span><i class="fa fa-star fill-star" aria-hidden="true"></i></span>
                      <span><i class="fa fa-star fill-star" aria-hidden="true"></i></span>
                  ...
                  <div class="rating-star-main">
                    ...
                    <input type="radio" <?php echo $rating_checked; ?> name="rattings" value="3.5"
                      class="float-left filter-click" data-field_slug="rating">
                    <div class="average-star rating-star">
                      <span><i class="fa fa-star fill-star" aria-hidden="true"></i></span>
                      <span><i class="fa fa-star fill-star" aria-hidden="true"></i></span>
                  ...
                  <div class="rating-star-main">
                    ...
                    <input type="radio" <?php echo $rating_checked; ?> name="rattings" value="3.0"
                      class="float-left filter-click" data-field_slug="rating">
                    <div class="average-star rating-star">
                      <span><i class="fa fa-star fill-star" aria-hidden="true"></i></span>
                      <span><i class="fa fa-star fill-star" aria-hidden="true"></i></span>
            ...
            <div class="card mb-1">
              ...
              <div id="collapsefour" class="collapse show" role="tabpanel">
                <div class="card-body p-1">
                  ...
                  ?>
                  <input type="radio" <?php echo $price_paid; ?> class="float-left filter-click" data-field_slug="price"
                    name="price" value="paid">
                  <div class="sub-category"><?php echo lang('paid'); ?></div>
                  <div class="clearfix"></div>
                  <input type="radio" <?php echo $price_free; ?> class="float-left filter-click" data-field_slug="price"
        ...
        <div class="col-10">
          <ul class="nav nav-tabs m-0 p-0 bg-white" id="my-profile-Tab" role="tablist">
            <li class="nav-item w-30">
              <a class="nav-link active" id="quiz-tab" data-toggle="tab" href="#quiz" role="tab" aria-controls="quiz"
                aria-selected="false"><?php echo lang('quiz'); ?></a>
            </li>
            <li class="nav-item w-30">
              <a class="nav-link " id="study-material-tab" data-toggle="tab" href="#study-material" role="tab"
                aria-controls="material" aria-selected="true"><?php echo lang('study_material'); ?></a>
            </li>
              ...
              <form action="" method="GET" id="Quiz_filter_form">
                <div class="form-controll">
                  <select class="form-control" id="Quiz_filter" name="most">
                    ...
                    <option <?php echo $this->input->get('most') == 'recent' ? 'Selected' : ''; ?> value="recent">
                      <?php echo lang('most_recent'); ?></option>
                    <option <?php echo $this->input->get('most') == 'liked' ? 'Selected' : ''; ?> value="liked">
                      <?php echo lang('most_liked'); ?></option>
                    <option <?php echo $this->input->get('most') == 'attended' ? 'Selected' : ''; ?> value="attended">
                      <?php echo lang('most_attended'); ?></option>
                  </select>
                </div>
              </form>
            </div>
